...
func (weed WeedStore) Put(src io.Reader) (string, error) {
...
func (weed WeedStore) Get(key string) (io.Reader, error) {
...
func InitWeed(masterUrl string) (WeedStore, error) {
	...
	fmt.Printf("%-20s%-20s\n", "weed.master_url:", masterUrl)

	return WeedStore{masterUrl: masterUrl}, nil
}
